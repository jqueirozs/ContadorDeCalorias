    ...
    <>
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <Button 
            onClick={() => window.location.href = "/app/reflection"}
            className="w-full flex items-center space-x-3 p-3 bg-secondary text-white hover:bg-secondary/90 mt-[20px] mb-[20px]"
          >
          ...
          <Button 
            onClick={() => window.location.href = "/app/exercises"}
            className="w-full flex items-center space-x-3 p-3 bg-accent text-white hover:bg-accent/90"
          >
